            ...
            <div class="row">
                <ul class="thumbnails">
                    <?php foreach ($this->images as $image) : ?>
                        <li class="span2">
                            <div class="thumbnail">
                                <a data-toggle="modal" href="index.php?option=com_instaboard&view=image&format=raw&id=<?php echo $image->id.'&'.JSession::getFormToken() .'=1';?>"><img src="<?php echo $image->images->thumbnail->url; ?>" alt=""></a>
                                <p>
